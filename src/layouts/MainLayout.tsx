        ...
        <header className="hidden md:flex h-16 items-center justify-between px-8 shrink-0 relative z-10">
          <div className="relative w-full max-w-xl">
             ...
             <input 
               ...
               className="w-full h-10 pl-10 pr-4 bg-muted/40 hover:bg-muted/60 transition-colors border-0 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 placeholder:text-muted-foreground/60"
             />
          </div>
