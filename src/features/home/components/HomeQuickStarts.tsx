    ...
    <div className="mt-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        {starts.map((start, i) => {
          ...
          return (
            <Link key={i} to={start.path} className="group">
              <Card className="h-full border border-border/60 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:border-slate-300 dark:hover:border-slate-700 transition-all cursor-pointer rounded-[16px] md:rounded-[20px] bg-card">
