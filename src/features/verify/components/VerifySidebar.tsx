    ...
    <div className="hidden xl:flex flex-col w-85 gap-6 shrink-0">
      ...
      <div className="bg-card text-card-foreground shadow-sm border border-border/50 rounded-2xl p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <Badge
            variant="outline"
            className={`font-bold px-2.5 py-0.5 text-[11px] ${metrics.incorrect > 0
        ...
        <div className="flex items-center gap-8 mb-2">
          ...
          <div className="flex flex-col gap-4 text-[13px] font-bold text-muted-foreground">
            <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-emerald-500 shadow-sm"></div> <span className="text-emerald-700 dark:text-emerald-400">{metrics.correct} Correct</span></div>
            <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-amber-500 shadow-sm"></div> <span className="text-amber-600 dark:text-amber-400">{metrics.partiallyCorrect} Partially Correct</span></div>
            <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-red-500 shadow-sm"></div> <span className="text-red-600 dark:text-red-400">{metrics.incorrect} Incorrect</span></div>
          </div>
        </div>
      </div>
